...
namespace HepsiBurada.MarsRover.ConsoleApplication
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //processManager.PlateauManager = plateuManager;
            //processManager.RoverManager = roverManager;
            //processManager.RoverCommandsManager = roverCommandsManager;
